...
<input type='hidden' name="PixGallery_VersionNumber" value="4.8.0">
...
<script type="text/javascript" src="<?php echo $PixGlobal_AdminPath; ?>support_files/tiny_mce/tiny_mce.js"></script>
	...
	tinyMCE.init({
		// General options
		theme : "modern",
		plugins : "pagebreak table emoticons insertdatetime preview media searchreplace codesample contextmenu paste directionality visualchars nonbreaking imagetools image link hr anchor wordcount lists textcolor code colorpicker",
		selector : 'textarea',
		resize: 'both',
width : "565",
	height : "250",
	browser_spellcheck: true,
		// Theme options
toolbar1: 'bold italic underline strikethrough | formatselect fontselect fontsizeselect',
		 toolbar2: 'cut copy paste pastetext pasteword | bullist numlist | outdent indent blockquote | undo redo | link unlink anchor image',
		 toolbar3: 'codesample | hr | emoticons media | ltr rtl | forecolor backcolor | code | insertdatetime preview'
});
</script>
<!-- /TinyMCE -->
<?php }
...
global $awsom_pixgallery_caption_table_name, $awsom_pixgallery_gallery_table_name, $PixGallery_UseVisualEditor;
	...
	if ($PixGallery_UseVisualEditor == 1){  ?>
<script type="text/javascript" src="<?php echo $PixGlobal_AdminPath; ?>support_files/tinymce/tinymce.min.js"></script>
	<script type="text/javascript">
	tinyMCE.init({
		// General options
		theme : "modern",
